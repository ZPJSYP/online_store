    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', tinymce.models.HTMLField(verbose_name='商品详情', blank=True, null=True)),
            ],
            options={
                'verbose_name': '商品SPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('display_type', models.SmallIntegerField(verbose_name='展示种类', default=1, choices=[(0, '标题'), (1, '图片')])),
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
