...
from tinymce.models import HTMLField #富文本编辑器需要在setting，url里面进行配置
...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='type', verbose_name='商品类型图片')  # upload_to里面的这个type是什么意思？
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE_CHOICES, verbose_name='展示种类')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
